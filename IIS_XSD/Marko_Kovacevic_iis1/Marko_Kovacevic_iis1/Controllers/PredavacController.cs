...
namespace Marko_Kovacevic_iis1.Controllers
{
    ...
    public class PredavacController : ControllerBase
    {
        ...
        public PredavacController(List<PredavacArray> listPredavac)
        {
            ListPredavac = listPredavac;
        }

        public List<PredavacArray> Get()
        {
            return ListPredavac;
        }
        ...
        [HttpPost]
        public void Post(PredavacArray newPredavac)
        {
            if (newPredavac != null)
            {
                ListPredavac.Add(newPredavac);
